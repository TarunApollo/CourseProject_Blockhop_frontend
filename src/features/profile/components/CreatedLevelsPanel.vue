...
<template>
  <section
    :class="[profileTokens.backgrounds.primaryPanel, 'w-full p-5 sm:p-6']"
  >
    <div class="mb-4">
      <p
        :class="[
      ...
      <h2 :class="[profileTokens.text.primary, 'mt-2 text-3xl']">
        My Created Levels
      </h2>
    </div>
    ...
    <button
      ...
      :class="[
        ...
        'mb-4 w-full flex items-center justify-center gap-3 px-4 py-5 cursor-pointer transition-colors hover:bg-[#A8E892]',
      ]"
      @click="showCreateModal = true"
    >
      <span
        :class="[profileTokens.text.primary, 'text-2xl font-bold leading-none']"
        >+</span
      >
      <span
        :class="[
