...
export async function setLevelAttitude(levelId, attitude) {
...
export async function clearLevelAttitude(levelId) {
...
export const setPublishedLevelAttitude = setLevelAttitude;
export const clearPublishedLevelAttitude = clearLevelAttitude;
