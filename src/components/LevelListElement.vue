...
<template>
    <div class="menu-button">
        ...
        <p>
            Times played: {{ props.level.timesPlayed }}
            -- 
            Completes: {{ props.level.timesCompleted }}
        </p>
        <div class="description-class"> {{ props.level.description }} </div>
    </div>
...
<style scoped>
    ...
    .preview {
        background-color: rgba(128, 48, 255, 0.1);
        width: 50%;
        height: 10em;
        visibility: visible;
