...
export class HorizontalFlyer {
  /**
   * Shared movement parameters for horizontally flying enemies (e.g. bees).
   *
   * Systems:
   * - `horizontalFlyerSystem` applies constant X velocity and flips render state.
   */
...
export class Bee {
  /**
   * Enemy subtype marker for flying bee enemies.
   *
   * This is intentionally a "marker" component; behavior lives in systems that
   * query `CT.Bee` and/or `CT.HorizontalFlyer`.
   */
